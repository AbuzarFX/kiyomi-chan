...
module.exports = {
    ...
    run: async (bot, message, args) => {
        if (!message.member.hasPermission("ADMINISTRATOR", "MANAGE_GUILD")) return message.channel.send("<:iconfinder_signerror_299045:796376441751076865> You do not have permissions to remove money!");
        ...
        let moneyEmbed = new MessageEmbed()
            .setColor("GREEN")
            .setDescription(`<:tick:788102360936218685> Removed ${args[1]} coins\n\nNew Balance: ${bal2}`);
