        ...
        if (!args[0]) {
            ...
            if (fishtime !== null && timeout - (Date.now() - fishtime) > 0) {
                ...
                let timeEmbed = new MessageEmbed()
                    .setColor("GREEN")
                    .setDescription(`<:iconfinder_signerror_299045:796376441751076865> You've Recently Casted A Line\n\nFish Again in ${time.minutes}m ${time.seconds}s `);
                return message.channel.send(timeEmbed)
            }

            let embed = new MessageEmbed()
                .setColor('GREEN')
                .setDescription(`**🎣 You Cast Out Your Line And Caught A ${fishh.symbol}, I Bet It'd Sell For Around ${worth}** <a:coin:806862664037957662>!`)
